!(function (t) {
  ...
  (e.prototype.init = function () {
    t("#sa-basic").on("click", function () {
      Swal.fire({ title: "Any fool can use a computer", confirmButtonColor: "#3d8ef8" });
    }),
      ...
      t(".sa-warning-delete").click(function () {
      ...
      t(".sa-warning-reset-pwd").click(function () {
        ...
        Swal.fire({
          title: "Are you sure?",
          text: "You will be reset the password of this account!",
          icon: "warning",
          showCancelButton: !0,
          confirmButtonColor: "#11c46e",
          cancelButtonColor: "#f46a6a",
          ...
          t.value && Swal.fire("Reset!", "The password has been reset.", "success");
        });
      }),
      t(".sa-warning-activate").click(function () {
        const form = this.parentElement;
        Swal.fire({
          title: "Are you sure?",
